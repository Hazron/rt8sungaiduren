...
$queryInsert = "INSERT INTO surat_pengantar (nama_pemohon, nik_pemohon, alamat_pemohon, keperluan, nomor_surat, status, id_keluarga, id_warga, upload, update_surat)
               VALUES ('$namaPemohon', '$nikPemohon', '$alamatPemohon', '$keperluan', 0, 'diproses', (SELECT id_keluarga FROM warga WHERE nama = '$namaPemohon'), (SELECT id FROM warga WHERE nama = '$namaPemohon'), NOW(), NULL)";
