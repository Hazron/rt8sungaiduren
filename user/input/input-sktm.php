...
// Query INSERT untuk menyimpan data ke dalam tabel surat_tidakmampu
$queryInsert = "INSERT INTO surat_tidakmampu (nomor_surat, nama_pemohon, alamat, upload, update_surat, id_warga, id_keluarga, status_surat) VALUES ('', '$namaPemohon', '$alamatPemohon', NULL, NULL, (SELECT id FROM warga WHERE nama = '$namaPemohon'), (SELECT id_keluarga FROM warga WHERE nama = '$namaPemohon'), 'diproses')";
